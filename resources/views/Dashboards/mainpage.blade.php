                    ...
                    <nav class="navbar navbar-expand-lg">
                        ...
                        <div class="-mr-36 collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                            <ul id="nav" class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item mt-2.5"><a class="" href="/med_ai">Booking</a></li>
                    ...
                    <nav class="navbar navbar-expand-lg">
                        ...
                        <div class="-mr-16 collapse navbar-collapse sub-menu-bar flex flex-row items-center"
                            ...
                            <ul id="nav" class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item my-auto"><a class="page-scroll" href="#about">About</a></li>
                                <li class="nav-item my-auto"><a target="_blank" href="#faqs">FAQs</a></li>
                                <li class="nav-item my-auto"><a target="_blank" href="#subscribe">Contact</a></li>
...
<div class=" w-full h-screen">
    <iframe src='https://my.spline.design/interactiveaistartupheropage-8bb9ff06cfd13c29bfdbbba263e5942c/'
            width='100%' height='100%'></iframe>
</div>
<div
    style="width: 170px; height: 37px; background-color: #00dab0; border-radius: 10px; position: absolute; top: 679px; right: 18px; display: flex; align-items: center; justify-content: center;"
    class="watermark-remover">
    <span style="color: whitesmoke; font-family: 'Nunito', sans-serif; font-weight: 700; padding: 5px;">FitFinity &nbsp;<span
            style="color: #003366">Healthcare</span> </span>
</div>
            ...
            <div class="col-xl-8 mx-auto">
                <div class="section-title text-center mb-55">
                    ...
                    <p class="wow fadeInUp" data-wow-delay=".6s">
                        We offer a broad range of medical services to meet your needs, from <br
                            class="d-none d-lg-block"/>
                        preventive care to specialized treatments and wellness programs.
                    </p>
                </div>
            </div>
        </div>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="40.839" height="48.598"
                            ...
                            <g id="we-do-1" transform="translate(-12.184 -5)">
                                <path id="Path_48" data-name="Path 48"
                                      ...
                                      transform="translate(0 -20.782)" fill="#E8BD70"/>
                                <g id="Group_129" data-name="Group 129" transform="translate(38.284 37.747)">
                                    <g id="Group_128" data-name="Group 128">
                                        <path id="Path_49" data-name="Path 49"
                                              ...
                                              transform="translate(-60.52 -65.645)" fill="#E8BD70"/>
                                    </g>
                                </g>
                                <path id="Path_50" data-name="Path 50"
                                      ...
                                      transform="translate(-8.746 -5.917)" fill="#E8BD70"/>
                                <path id="Path_51" data-name="Path 51"
                                      ...
                                      transform="translate(-9.125)" fill="#E8BD70"/>
                            </g>
                        </svg>
                    </div>
                            ...
                            <g id="we-do-2" transform="translate(12.41 -88.75)">
                                <g id="Group_133" data-name="Group 133" transform="translate(-12.41 88.75)">
                                    <path id="Path_52" data-name="Path 52"
                                          ...
                                          transform="translate(-5.638 -11.855)" fill="#E8BD70"/>
                                    ...
                                    <path id="Path_54" data-name="Path 54"
                                          ...
                                          transform="translate(-5.472 -9.882)" fill="#E8BD70"/>
                                    <path id="Path_55" data-name="Path 55"
                                          ...
                                          transform="translate(-6.036 -8.3)" fill="#E8BD70"/>
                                    ...
                                    <path id="Path_57" data-name="Path 57"
                                          ...
                                          transform="translate(-2.585 -11.751)" fill="#E8BD70"/>
                                ...
                                <g id="Icon_feather-home" data-name="Icon feather-home"
                                   transform="translate(1275 1753.846)">
                                    <path id="Path_108" data-name="Path 108"
                                          ...
                                          transform="translate(-4.5 -3)" fill="none" stroke="#E8BD70"
                                          stroke-linecap="round" stroke-linejoin="round" stroke-width="3"/>
                                </g>
                                <path id="Union_1" data-name="Union 1" d="M7.658,6.87h0v0h0v0Z"
                                      transform="translate(1288.853 1775.014)" fill="none" stroke="#E8BD70"
                                      stroke-linecap="round" stroke-linejoin="round" stroke-width="3"/>
                            </g>
                        </svg>
                    </div>
            ...
            <div class="col-xl-10 col-lg-11 mx-auto">
                <div class="about-content text-center mb-55">
                    ...
                    <p class="mb-35 wow fadeInUp" data-wow-delay=".6s">
                        We offer a range of health services designed to improve your well-being. From personalized
                        medical consultations to holistic wellness programs, our team is dedicated to supporting your
                        health journey.
                    </p>
        ...
        <div class="row">
            <div class="col-xl-8 mx-auto">
                <div class="section-title text-center mb-55">
                    ...
                    <p class="wow fadeInUp" data-wow-delay=".6s">
                        We offer a comprehensive range of healthcare services designed to meet your needs. From routine
                        check-ups to specialized treatments, our dedicated team is here to provide you with the highest
                        quality care. <br class="d-none d-lg-block"/> Your health and well-being are our top priorities.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="service-item mb-30">
                    ...
                    <div class="service-content">
                        <h4>Cardiology</h4>
                        <p> Comprehensive heart care, diagnostics, and services by expert cardiologists. </p>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="57.792" height="58.716"
                            ...
                            <g id="noun_Brain_2581553" transform="translate(-5.696 -4.966)">
                                ...
                                <path id="Path_677" data-name="Path 67"
                                      ...
                                      transform="translate(0 -4.84)" fill="#0bb288"/>
                                <path id="Path_68" data-name="Path 68"
                                      ...
                                      transform="translate(-4.911 -10.098)" fill="#0bb288"/>
                                <path id="Path_699" data-name="Path 69"
                                      ...
                                      transform="translate(-12.654 -10.116)" fill="#0bb288"/>
                            </g>
                        </svg>
                    </div>
                    <div class="service-content">
                        <h4>Neurology</h4>
                        <p> Expert care for brain system, spinal cord, and nerve disorders by specialized
                            neurologists. </p>
                        <a href="#" class="read-more">Read More <i class="lni lni-arrow-right"></i></a>
                    </div>
                    <div class="service-overlay img-bg"></div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="service-item mb-30">
                            ...
                            <g id="noun_Stomach_576009" transform="translate(-4.423 -0.572)">
                                <g id="Group_152" data-name="Group 152" transform="translate(4.423 0.572)">
                                    ...
                                    <path id="Path_71" data-name="Path 71"
                                          ...
                                          transform="translate(-5.596 -3.409)" fill="#0bb288"/>
                                </g>
                            </g>
                        </svg>
                    </div>
                    <div class="service-content">
                        ...
                        <p> Specialized care for digestive system disorders, including diagnosis, treatment, and
                            prevention. </p>
                        <a href="#" class="read-more">Read More <i class="lni lni-arrow-right"></i></a>
                    </div>
                    <div class="service-overlay img-bg"></div>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="43.302" height="58.633"
                            ...
                            <g id="noun_womb_1744327" transform="translate(-22.94 -12.449)">
                                <path id="Path_81" data-name="Path 81"
                                      ...
                                      transform="translate(-0.985 -4.655)" fill="#0bb288"/>
                                ...
                                <path id="Path_83" data-name="Path 83"
                                      ...
                                      transform="translate(-0.997 -4.602)" fill="#0bb288"/>
                            </g>
                        </svg>
                    </div>
                    <div class="service-content">
                        <h4>Gynecology</h4>
                        <p> Comprehensive care for women's reproductive health, including diagnosis, treatment, and
                            prevention. </p>
                        <a href="#" class="read-more">Read More <i class="lni lni-arrow-right"></i></a>
                    </div>
                    <div class="service-overlay img-bg"></div>
                    ...
                    <div class="faq-wrapper accordion" id="accordionExample">
                        <div class="faq-item mb-20">
                            ...
                            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                ...
                                <div class="faq-content">
                                    An academic medical center combines education, research, and clinical care, offering
                                    comprehensive services while training future healthcare professionals. These centers
                                    are typically affiliated with a university or medical school.
                                </div>
                            </div>
                        </div>
                        <div class="faq-item mb-20">
                            <div id="headingTwo">
                                <h5 class="mb-0">
                                    <button class="faq-btn btn collapsed" type="button" data-toggle="collapse"
                                        ...
                                        What services are provided at an academic medical center? <i class="lni"></i>
                                    </button>
                                </h5>
                            </div>
                            ...
                            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                                 data-parent="#accordionExample">
                                <div class="faq-content">
                                    Academic medical centers offer a wide range of services, including specialized care,
                                    advanced treatments, and access to clinical trials. They also provided training and
                        ...
                        <div class="faq-item mb-20">
                            <div id="headingThree">
                                <h5 class="mb-0">
                                    <button class="faq-btn btn collapsed" type="button" data-toggle="collapse"
                                        ...
                                        Why choose an academic medical center for treatment? <i class="lni"></i>
                                    </button>
                                </h5>
                            </div>
                            ...
                            <div id="collapseThree" class="collapse" aria-labelledby="headingThree"
                                 data-parent="#accordionExample">
                                <div class="faq-content">
                                    Academic medical centers are known for cutting-edge research and access to the
                                    latest treatments. Patients receive care from leading experts in the field who are
                                    also involved in teaching and research.
                                </div>
                            </div>
                        </div>
                        <div class="faq-item">
                            ...
                            <div id="collapseFour" class="collapse" aria-labelledby="headingFour"
                                 data-parent="#accordionExample">
                                <div class="faq-content">
                                    Residents are supervised by attending physicians who are experienced doctors,
                                    ensuring they receive proper guidance while gaining hands-on experience. Supervision
                                    helps maintain high standards of patient care.
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-xl-7">
                <div class="section-title">
                    ...
                    <p class="mb-35">
                        Keep up with the latest news, health tips, and updates from our team. <br
                            class="d-none d-lg-block"/>
                        Subscribe now to ensure you never miss out on important information.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="col-xl-8">
                <div class="subscribe-wrapper">
                    ...
                    <div class="subscribe-links">
                        <ul>
                            <li>
                                <a href="#"><i class="lni lni-phone-set"></i>
            ...
            <div class="col-xl-8 mx-auto">
                <div class="section-title text-center mb-55">
                    ...
                    <p class="wow fadeInUp" data-wow-delay=".4s">
                        Stay updated with the latest advancements and expert insights in the medical field. <br
                            class="d-none d-lg-block"/>
                        Our blog shares tips, news, and research to keep you informed.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="single-blog mb-30 wow fadeInUp" data-wow-delay=".2s">
                    ...
                    <div class="blog-content">
                        ...
                        <p>
                            Discover essential medical advice that can improve your health and well-being. Explore these
                            tips to enhance your daily routine and overall wellness.
                        </p>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="single-blog mb-30 wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <div class="blog-content">
                        ...
                        <p>
                            Dive into our collection of medical tips designed to help you navigate your health journey
            ...
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="single-blog mb-30 wow fadeInUp" data-wow-delay=".6s">
                    ...
                    <div class="blog-content">
                        <h4><a href="#">250+ Medical Tips We Just Had to Share</a></h4>
                        <p>
                            Explore a curated list of medical insights that will empower you to make informed decisions
                ...
                <div class="col-xl-4 col-lg-5 col-md-6">
                    <div class="footer-widget mb-30">
                        ...
                        <p>
                            ...
                            services. Stay connected with us through our social media channels for the latest updates
                            and offers.
                        </p>
                    ...
                    <div class="footer-widget mb-30">
                        ...
                        <div class="map-canvas">
                            <iframe class="map" id="gmap_canvas"
                                    ...
                                    style="border: 0; border-radius: 20px; box-shadow: 1px 1px 10px black;"
