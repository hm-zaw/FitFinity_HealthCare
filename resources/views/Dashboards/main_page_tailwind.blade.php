...
<header id="home" class="header">
    ...
    <div class="relative w-full h-screen">
        <iframe src='https://my.spline.design/interactiveaistartupheropage-8bb9ff06cfd13c29bfdbbba263e5942c/' frameborder='0' width='100%' height='100%'></iframe>
    </div>
</header>

<div style="width: 150px; height: 37px; background-color: #00dab0; position: absolute; top: 958px; right: 20px;" class="watermark-remover"></div>
        ...
        <div class="flex flex-wrap -mx-4">
            <div class="col-xl-8 mx-auto">
                <div class="section-title text-center mb-55">
                    ...
                    <p class="wow fadeInUp" data-wow-delay=".6s"> We offer a range of health services designed to improve your well-being. From personalized medical consultations to holistic wellness programs, our team is dedicated to supporting your health journey. </p>
                </div>
            </div>
        </div>
        <div class="flex flex-wrap -mx-4">
                            ...
                            <g id="we-do-2" transform="translate(12.41 -88.75)">
                                <g id="Group_133" data-name="Group 133" transform="translate(-12.41 88.75)" >
                                    ...
                                    <path id="Path_58" data-name="Path 58" d="M1.6,28.616a23.136,23.136,0,0,0,1.24,7.528c.266.974.531,2.037.8,3.1.709,2.391,1.949,3.986,3.72,4.606a10.569,10.569,0,0,0,3.277.531c.974,0,1.949-.089,2.923-.177L13.29,41.99a12.826,12.826,0,0,1-5.226-.177C7,41.37,6.2,40.4,5.673,38.624c-.266-.974-.531-2.037-.8-3.011A26.232,26.232,0,0,1,3.725,28.7c0-1.417.266-1.949.886-2.3a2.051,2.051,0,0,1,2.126.354,2.6,2.6,0,0,1,.886,1.063c.089.177.089.266.177.443.089.354.266.709.354,1.063a.8.8,0,0,0,.089.443c.089.974.177,2.391,1.506,3.1h.089c.62.354,5.226,2.746,5.226,2.746a1.11,1.11,0,0,0,1.063-1.949c-3.9-2.037-4.96-2.657-5.314-2.746h0c-.266-.089-.354-.886-.354-1.329a1.729,1.729,0,0,0-.089-.62,7.481,7.481,0,0,0-.443-1.506,4.318,4.318,0,0,1-.266-.62,6.368,6.368,0,0,0-1.594-1.86,4.32,4.32,0,0,0-4.34-.531C1.6,25.428,1.6,27.465,1.6,28.616Z"
                                          transform="translate(-1.59 -10.105)" fill="#E8BD70" />
                                </g>
                            </g>
                        </svg>
                    </div>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="48.152" height="48.154" viewBox="0 0 48.152 48.154" >
                            <g id="we-do-3" transform="translate(-1.846 -1.846)">
                                <path id="Path_59" data-name="Path 59" d="M46,18.78A3.994,3.994,0,0,0,42.432,21L32.309,17.386a6.492,6.492,0,0,0,.08-1.008,6.36,6.36,0,0,0-1.262-3.8l5.65-3.767a4.037,4.037,0,1,0-.887-1.333L30.006,11.4a6.367,6.367,0,0,0-7.877-.124L19.685,8.223a4.064,4.064,0,1,0-1.158,1.115l2.45,3.061a6.374,6.374,0,0,0-1.34,3.179H9.894a4,4,0,1,0,0,1.6h9.738a6.335,6.335,0,0,0,.64,2.105L8.221,29.08a4.063,4.063,0,1,0,1.114,1.156l12.136-9.86a.8.8,0,0,0,.571-1.254,4.8,4.8,0,1,1,7.885,0l1.313.915a6.319,6.319,0,0,0,.607-1.117l10.171,3.633c0,.08-.023.15-.023.228a4,4,0,1,0,4-4Zm-6.4-15.21a2.4,2.4,0,1,1-2.4,2.4,2.4,2.4,0,0,1,2.4-2.4Zm-23.215,4.8a2.4,2.4,0,1,1,2.4-2.4A2.4,2.4,0,0,1,16.379,8.373ZM5.972,18.78a2.4,2.4,0,1,1,2.4-2.4,2.4,2.4,0,0,1-2.4,2.4Zm0,16.01a2.4,2.4,0,1,1,2.4-2.4,2.4,2.4,0,0,1-2.4,2.4ZM46,25.184a2.4,2.4,0,1,1,2.4-2.4A2.4,2.4,0,0,1,46,25.184Z"
                                      transform="translate(0 0)" fill="#E8BD70"/>
                                <path id="Path_60" data-name="Path 60"  d="M44.414,30.808a3.194,3.194,0,0,0-2.4,1.086,3.2,3.2,0,0,0-4.8,0,3.2,3.2,0,0,0-4-.656V21.2a3.2,3.2,0,0,0-6.4,0V34.09a5.588,5.588,0,0,0-4-1.681.8.8,0,0,0-.8.8V47.619a.8.8,0,0,0,.234.566l5.038,5.038h2.264L23.6,47.287V34.09a4.009,4.009,0,0,1,3.2,3.923v5.6a.8.8,0,0,0,1.6,0V21.2a1.6,1.6,0,1,1,3.2,0V35.611a.8.8,0,0,0,1.6,0v-1.6a1.6,1.6,0,0,1,3.2,0v1.6a.8.8,0,1,0,1.6,0v-1.6a1.6,1.6,0,0,1,3.2,0v1.6a.8.8,0,0,0,1.6,0v-1.6a1.6,1.6,0,0,1,3.2,0V53.222h1.6V34.01A3.2,3.2,0,0,0,44.414,30.808Z"
                                      transform="translate(-4.02 -3.223)" fill="#E8BD70"  />
                            </g>
                        </svg>
                    </div>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="46.239" height="51.043" viewBox="0 0 46.239 51.043">
                            <g id="we-do-4" transform="translate(-1273.5 -1752.346)">
                                <g id="Icon_feather-home" data-name="Icon feather-home" transform="translate(1275 1753.846)" >
                                    <path id="Path_108" data-name="Path 108" d="M4.5,19.815,26.119,3,47.739,19.815V46.239a4.8,4.8,0,0,1-4.8,4.8H9.3a4.8,4.8,0,0,1-4.8-4.8Z"
                                          transform="translate(-4.5 -3)" fill="none" stroke="#E8BD70" stroke-linecap="round" stroke-linejoin="round" stroke-width="3" />
                                </g>
                                <path id="Union_1" data-name="Union 1" d="M7.658,6.87h0v0h0v0Z" transform="translate(1288.853 1775.014)" fill="none" stroke="#E8BD70" stroke-linecap="round" stroke-linejoin="round" stroke-width="3"/>
                            </g>
                        </svg>
                    </div>
        ...
        <div class="flex flex-wrap -mx-4">
            <div class="col-xl-10 col-lg-11 mx-auto">
                <div class="about-content text-center mb-55">
                    ...
                    <p class="mb-35 wow fadeInUp" data-wow-delay=".6s"> At our clinic, we are dedicated to providing top-notch healthcare services to our community. Our team of experienced professionals is committed to ensuring your well-being through personalized care and advanced medical treatments. Your health and comfort are our top priorities, and we strive to create a welcoming and supportive environment for all our patients. </p>
                    <a href="#" class=" theme- wow fadeInUp" data-wow-delay=".8s" >Learn More</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-xl-8 mx-auto">
                <div class="section-title text-center mb-55">
                    ...
                    <p class="wow fadeInUp" data-wow-delay=".6s">
                        We offer a comprehensive range of healthcare services designed to meet your needs. From routine check-ups to specialized treatments, our dedicated team is here to provide you with the highest quality care. <br class="d-none d-lg-block" /> Your health and well-being are our top priorities.
                    </p>
                </div>
            </div>
        </div>
        <div class="flex flex-wrap -mx-4">
            <div class="col-lg-4 w-full md:w-1/2 px-4">
                <div class="service-item mb-30">
                            ...
                            <g id="noun_Cardiology_1744691" transform="translate(0 0.005)">
                                <g id="Layer_2" data-name="Layer 2" transform="translate(0 -0.005)">
                                    <g id="Layer_1" data-name="Layer 1" transform="translate(0 0)" >
                                        ...
                                        <path id="Path_65" data-name="Path 65" d="M29.19,39.18,25.769,27.955l-2.021,4.463H1.949a1.949,1.949,0,1,1,0-3.9H21.234l5.251-11.6,3.866,12.729,7.041-11.782L41.37,29.172l6.786-8.751,5.4,6.07h24.05a1.949,1.949,0,0,1,0,3.9H51.776l-3.445-3.859-8.29,10.7-3.6-10.215Z"
                                              transform="translate(0 -3.455)" fill="#0bb288" />
                                    </g>
                                </g>
                            </g>
                        </svg>
                    ...
                    <div class="service-content">
                        <h4>Cardiology</h4>
                        <p> Comprehensive heart care, diagnostics, treatment, and preventive services by expert cardiologists. </p>
            ...
            <div class="col-lg-4 w-full md:w-1/2 px-4">
                <div class="service-item mb-30">
                    ...
                    <div class="service-content">
                        ...
                        <p> Specialized care for digestive system disorders, including diagnosis, treatment, and prevention. </p>
                        <a href="#" class="read-more">Read More <i class="lni lni-arrow-right"></i></a>
                    </div>
                    <div class="service-overlay img-bg"></div>
                </div>
            ...
            <div class="col-lg-4 w-full md:w-1/2 px-4">
                <div class="service-item mb-30">
                    ...
                    <div class="service-content">
                        <h4>Orthopedics</h4>
                        <p> Comprehensive care for bones, joints, muscles, and ligaments by orthopedic specialists. </p>
                        <a href="#" class="read-more">Read More <i class="lni lni-arrow-right"></i></a>
                    </div>
                    <div class="service-overlay img-bg"></div>
                </div>
            ...
            <div class="col-lg-4 w-full md:w-1/2 px-4">
                <div class="service-item mb-30">
                    ...
                    <div class="service-content">
                        ...
                        <p> Specialized care for ear, nose, throat, head, and neck disorders by expert ENT doctors. </p>
                        <a href="#" class="read-more" >Read More <i class="lni lni-arrow-right"></i></a>
                    </div>
                    <div class="service-overlay img-bg"></div>
                </div>
            ...
            <div class="col-xl-6 offset-xl-6 col-lg-8 col-md-10">
                <div class="faq-content-wrapper pt-90 pb-90">
                    <div class="section-title">
                        <span class="text-white wow fadeInDown" data-wow-delay=".2s">Frequently Asked Questions</span>
                        <h2 class="text-white mb-35 wow fadeInUp" data-wow-delay=".4s">
                        ...
                        <div class="faq-item mb-20">
                            <div id="headingOne">
                                <h5 class="mb-0">
                                    <button class="faq-btn btn" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne" >
                                        How can I book an appointment using the online booking system for healthcare services? <i class="lni"></i>
                                    </button>
                                </h5>
                            </div>
                            ...
                            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample" >
                                <div class="faq-content">
                                    To book an appointment online, simply visit our website and navigate to the appointment booking section. From there, you can select your preferred healthcare service, choose a convenient date and time from the available slots, and provide your contact information. Once your appointment is confirmed, you'll receive a confirmation email or SMS with all the necessary details.
                                </div>
                            </div>
                        </div>
                        <div class="faq-item mb-20">
                            <div id="headingTwo">
                                <h5 class="mb-0">
                                    <button class="faq-btn btn collapsed" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo" >
                                        Can I reschedule or cancel my appointment through the online booking system? <i class="lni"></i>
                                    </button>
                                </h5>
                            </div>
                            ...
                            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample" >
                                <div class="faq-content">
                                    Yes, you can easily reschedule or cancel your appointment through our online booking system. Simply log in to your account, navigate to your upcoming appointments, and select the option to reschedule or cancel. Please ensure to do so within the specified timeframe to avoid any inconvenience.
                                </div>
                            </div>
                        </div>
                        <div class="faq-item mb-20">
                            <div id="headingThree">
                                <h5 class="mb-0">
                                    <button class="faq-btn btn collapsed" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="true" aria-controls="collapseThree" >
                                        How far in advance can I book appointments online? <i class="lni"></i>
                                    </button>
                                </h5>
                            </div>
                            ...
                            <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample" >
                                <div class="faq-content">
                                    You can typically book appointments online up to several weeks in advance, depending on the availability of our healthcare providers and the type of service you're seeking. We recommend booking your appointment as early as possible to secure your preferred date and time.
                                </div>
                            </div>
                        </div>
                        <div class="faq-item">
                            <div id="headingFour">
                                <h5 class="mb-0">
                                    <button class="faq-btn btn collapsed" type="button" data-toggle="collapse"
                                        ...
                                        Is my personal information secure when booking appointments online? <i class="lni"></i>
                                    </button>
                                </h5>
                            </div>
                            ...
                            >
                                <div class="faq-content">
                                    Yes, we take the security and privacy of your personal information very seriously. Our online booking system utilizes industry-standard encryption and security measures to safeguard your data. Additionally, we adhere to strict privacy policies to ensure that your information is protected and used only for the purpose of scheduling and providing healthcare services.
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="flex flex-wrap -mx-4">
            <div class="col-xl-7">
                <div class="section-title">
                    ...
                    <p class="mb-35"> Lorem ipsum dolor sit amet, consetetur sadiping elitr, sed dinonumy <br class="d-none d-lg-block" /> eirmod tempor invidunt ut labore. </p>
                </div>
            </div>
        </div>
        <div class="flex flex-wrap -mx-4">
            ...
            <div class="col-xl-4 col-lg-4 w-full md:w-1/2 px-4">
                <div class="single-blog mb-30 wow fadeInUp" data-wow-delay=".2s">
                    ...
                    <div class="blog-content">
                        ...
                        <p> Lorem ipsum dolor sirtewt amertse consetetur sadipscing elitr, sedqw dinoumy eirmod tempor invidunt sedrsu. </p>
    ...
    <div class="mx-auto max-w-screen-lg px-4">
            ...
            <div class="flex flex-wrap -mx-4">
                <div class="col-xl-4 col-lg-5 w-full md:w-1/2 px-4">
                    <div class="footer-widget mb-30">
                        <a href="index.html" class="logo"><img src="../../../assets/images/logo/logo.svg" alt=""/></a>
                ...
                <div class="col-xl-4 col-lg-12 col-md-7">
                    <div class="footer-widget mb-30">
                        ...
                        <div class="map-canvas">
                            <iframe class="map" id="gmap_canvas" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3818.404402058949!2d96.13308881455715!3d16.8558781223534!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30c1936f625d4ba7%3A0x9676670831769962!2sUniversity%20of%20Information%20Technology(UIT)!5e0!3m2!1sen!2smm!4v1675524353877!5m2!1sen!2smm" width="100%" height="400" style=" border: 0; border-radius: 20px; box-shadow: 1px 1px 10px black;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" ></iframe>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="copyright-area">
            ...
            <p class="mb-0 text-center">
                ...
                <a href="https://www.facebook.com/htetpainglinn28?mibextid=ZbWKwL" rel="nofollow" >Fitfinity Team</a>
            </p>
        </div>
    </div>
</footer>
